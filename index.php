...
<?php include 'layouts/header.php'; ?>
    ...
    <section id="home" class="min-h-screen flex items-center justify-center pt-16 md:pt-20 px-5 sm:px-5">
        <div class="container mx-auto max-w-7xl px-0 py-0 md:py-24 flex flex-col md:flex-row items-center gap-2">
            ...
            <div class="md:w-1/2 lg:w-2/5 xl:w-1/2 flex justify-center relative order-1 md:order-2 mb-10 md:mb-0">
                <div class="relative w-full max-w-md xl:max-w-lg aspect-[9/11] group perspective-1000">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-br from-primary-light/10 dark:from-primary-dark/10 to-accent-light/10 dark:to-accent-dark/10 rounded-2xl blur-xl animate-pulse-slow z-0"></div>
                    <div class="absolute inset-4 bg-gradient-to-br from-primary-light/5 dark:from-primary-dark/5 to-accent-light/5 dark:to-accent-dark/5 rounded-xl blur-lg animate-pulse-slow z-0"></div>
    
                    <!-- Main image container -->
                    <div class="relative w-full h-full overflow-hidden rounded-2xl shadow-2xl border-2 border-primary-light/20 dark:border-primary-dark/20 
                        ...
                        <img src="shivampic1.png" alt="Professional Portrait of Shivam Mishra"
                            ...
                            loading="eager" />
                        <div class="absolute inset-0 bg-gradient-to-t from-dark-light/40 dark:from-dark-dark/40 via-transparent to-transparent"></div>
                    </div>
            ...
            <div class="md:w-1/2 lg:w-3/5 xl:w-1/2 space-y-6 md:space-y-8 text-center md:text-left order-2 md:order-1">
                ...
                <div class="flex flex-row gap-4 justify-center md:justify-start">
                    <a href="#contact" class="w-auto px-8 py-3.5 bg-gradient-to-r from-primary-light dark:from-primary-dark to-accent-light dark:to-accent-dark rounded-full font-medium hover:opacity-90 transition-all 
                    ...
                    <a href="#projects" class="w-auto px-8 py-3.5 border-2 border-primary-light/30 dark:border-primary-dark/30 text-primary-light dark:text-primary-dark rounded-full font-medium hover:bg-primary-light/5 dark:hover:bg-primary-dark/5 
                       transition-all hover:border-primary-light/50 dark:hover:border-primary-dark/50 shadow hover:shadow-primary-light/20 dark:hover:shadow-primary-dark/20 text-center">
                        View Projects
                    </a>
                </div>
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="flex flex-col md:flex-row items-center">
                ...
                <div class="md:w-1/3 mb-8 md:mb-0 flex justify-center">
                    <div class="w-64 h-64 rounded-full overflow-hidden border-4 border-primary-light/30 dark:border-primary-dark/30">
                ...
                <div class="md:w-2/3 md:pl-12">
                    ...
                    <div class="bg-white dark:bg-darker p-6 rounded-xl mb-8 shadow-md">
                        <h4 class="text-lg font-semibold mb-4 text-primary-light dark:text-primary-dark">Personal Information</h4>
    ...
    <section id="skills" class="py-20 bg-white dark:bg-dark">
        <div class="container mx-auto px-6">
            ...
            <div class="flex flex-wrap justify-center mb-8 border-b border-gray-300 dark:border-gray-700">
                <button class="tab-btn px-6 py-3 font-medium text-lg flex items-center justify-center gap-2 border-b-2 border-transparent hover:border-accent-light dark:hover:border-accent-dark transition-all active-tab" data-tab="all">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                    </svg>
                    All Skills
                </button>
                <button class="tab-btn px-6 py-3 font-medium text-lg flex items-center justify-center gap-2 border-b-2 border-transparent hover:border-accent-light dark:hover:border-accent-dark transition-all" data-tab="programming">
                    <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/php/php-original.svg" class="w-6 h-6" alt="PHP" />
                    Programming
                </button>
                <button class="tab-btn px-6 py-3 font-medium text-lg flex items-center justify-center gap-2 border-b-2 border-transparent hover:border-accent-light dark:hover:border-accent-dark transition-all" data-tab="web">
                    <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original.svg" class="w-6 h-6" alt="Web" />
                    Web Technologies
                </button>
                <button class="tab-btn px-6 py-3 font-medium text-lg flex items-center justify-center gap-2 border-b-2 border-transparent hover:border-accent-light dark:hover:border-accent-dark transition-all" data-tab="tools">
                    <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-original.svg" class="w-6 h-6" alt="Tools" />
                    Tools & More
                </button>
            </div>
            ...
            <div class="tab-content">
                ...
                <div id="all" class="tab-pane active">
                    <div class="flex flex-wrap justify-center gap-6 text-center ">
                        <!-- Programming Skills -->
                        <div class="px-6 py-4 bg-gray-100 dark:bg-dark rounded-lg flex flex-col items-center w-40 hover:scale-105 transition-transform">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/php/php-original.svg" class="w-12 h-12 mb-2" alt="PHP" />
                            <span>PHP</span>
                        </div>
                        <div class="px-6 py-4 bg-gray-100 dark:bg-dark rounded-lg flex flex-col items-center w-40 hover:scale-105 transition-transform">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Laravel.svg/800px-Laravel.svg.png" class="w-12 h-12 mb-2" alt="Laravel" />
                            <span>Laravel</span>
                        </div>
                        <div class="px-6 py-4 bg-gray-100 dark:bg-dark rounded-lg flex flex-col items-center w-40 hover:scale-105 transition-transform">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/codeigniter/codeigniter-plain.svg" class="w-12 h-12 mb-2" alt="CodeIgniter" />
                            <span>CodeIgniter</span>
                        </div>
                        <div class="px-6 py-4 bg-gray-100 dark:bg-dark rounded-lg flex flex-col items-center w-40 hover:scale-105 transition-transform">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/java/java-original.svg" class="w-12 h-12 mb-2" alt="Java" />
                            <span>Java</span>
                        </div>
                        
                        <!-- Web Skills -->
                        <div class="px-6 py-4 bg-gray-100 dark:bg-dark rounded-lg flex flex-col items-center w-40 hover:scale-105 transition-transform">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original.svg" class="w-12 h-12 mb-2" alt="HTML5" />
                            <span>HTML5</span>
                        </div>
                        <div class="px-6 py-4 bg-gray-100 dark:bg-dark rounded-lg flex flex-col items-center w-40 hover:scale-105 transition-transform">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/css3/css3-original.svg" class="w-12 h-12 mb-2" alt="CSS3" />
                            <span>CSS3</span>
                        </div>
                        <div class="px-6 py-4 bg-gray-100 dark:bg-dark rounded-lg flex flex-col items-center w-40 hover:scale-105 transition-transform">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg" class="w-12 h-12 mb-2" alt="JavaScript" />
                            <span>JavaScript</span>
                        </div>
                        <div class="px-6 py-4 bg-gray-100 dark:bg-dark rounded-lg flex flex-col items-center w-40 hover:scale-105 transition-transform">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/wordpress/wordpress-original.svg" class="w-12 h-12 mb-2" alt="WordPress" />
                            <span>WordPress</span>
                        </div>
                        <div class="px-6 py-4 bg-gray-100 dark:bg-dark rounded-lg flex flex-col items-center w-40 hover:scale-105 transition-transform">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original.svg" class="w-12 h-12 mb-2" alt="MySQL" />
                            <span>MySQL</span>
                        </div>
                        
                        <!-- Tools & More -->
                        <div class="px-6 py-4 bg-gray-100 dark:bg-dark rounded-lg flex flex-col items-center w-40 hover:scale-105 transition-transform">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-original.svg" class="w-12 h-12 mb-2" alt="Git" />
                            <span>Git/GitHub</span>
                        </div>
                        <div class="px-6 py-4 bg-gray-100 dark:bg-dark rounded-lg flex flex-col items-center w-40 hover:scale-105 transition-transform">
                            <img src="https://miro.medium.com/v2/resize:fit:440/1*J3G3akaMpUOLegw0p0qthA.png" class="w-12 h-12 mb-2" alt="API" />
                            <span>RESTful APIs</span>
                        </div>
                        <div class="px-6 py-4 bg-gray-100 dark:bg-dark rounded-lg flex flex-col items-center w-40 hover:scale-105 transition-transform">
                            <img src="https://cdn2.iconfinder.com/data/icons/programming-76/512/MVC-model-view-controller-512.png" class="w-12 h-12 mb-2" alt="MVC" />
                            <span>MVC Architecture</span>
                        </div>
                        <div class="px-6 py-4 bg-gray-100 dark:bg-dark rounded-lg flex flex-col items-center w-40 hover:scale-105 transition-transform">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/bootstrap/bootstrap-original.svg" class="w-12 h-12 mb-2" alt="Bootstrap" />
                            <span>Bootstrap</span>
                        </div>
                        <div class="px-6 py-4 bg-gray-100 dark:bg-dark rounded-lg flex flex-col items-center w-40 hover:scale-105 transition-transform">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/jquery/jquery-original.svg" class="w-12 h-12 mb-2" alt="jQuery" />
                ...
                <div id="tools" class="tab-pane hidden">
                    <div class="flex flex-wrap justify-center gap-6 text-center">
                        ...
                        <div class="px-6 py-4 bg-gray-100 dark:bg-dark rounded-lg flex flex-col items-center w-40 hover:scale-105 transition-transform">
                            <img src="https://w7.pngwing.com/pngs/915/723/png-transparent-model-view-controller-mvc-thumbnail.png" class="w-12 h-12 mb-2" alt="MVC" />
                            <span>MVC Architecture</span>
                        </div>
                        <div class="px-6 py-4 bg-gray-100 dark:bg-dark rounded-lg flex flex-col items-center w-40 hover:scale-105 transition-transform">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/bootstrap/bootstrap-original.svg" class="w-12 h-12 mb-2" alt="Bootstrap" />
    ...
    <section id="education" class="py-16 bg-gray-100 dark:bg-[#0b0b0b]">
        <div class="container mx-auto px-6">
           ...
           <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                <!-- MCA Card -->
                <div class="bg-white dark:bg-dark p-6 rounded-xl border border-gray-200 dark:border-gray-800 hover:border-primary-light dark:hover:border-primary-dark transition-all duration-300 hover:shadow-lg hover:-translate-y-1 flex flex-col h-full equal-height">
                    <div class="flex justify-between items-start mb-4">
                        <div>
                            <div class="w-12 h-12 bg-primary-light/10 dark:bg-primary-dark/10 rounded-lg flex items-center justify-center mb-3">
                                <i class="fas fa-graduation-cap text-primary-light dark:text-primary-dark text-xl"></i>
                            </div>
                            <h3 class="text-xl font-bold text-primary-light dark:text-primary-dark">Master of Computer Applications</h3>
                            <p class="text-gray-500 dark:text-gray-400 text-sm mt-1">Maharishi University, Lucknow</p>
                        </div>
                        <span class="bg-primary-light/20 dark:bg-primary-dark/20 text-primary-light dark:text-primary-dark text-xs px-3 py-1 rounded-full h-fit whitespace-nowrap">
                            2023–2025
                        </span>
                    </div>
                ...
                <!-- PG Diploma Card -->
                <div class="bg-white dark:bg-dark p-6 rounded-xl border border-gray-200 dark:border-gray-800 hover:border-secondary-light dark:hover:border-secondary-dark transition-all duration-300 hover:shadow-lg hover:-translate-y-1 flex flex-col h-full equal-height">
                    <div class="flex justify-between items-start mb-4">
                        <div>
                            <div class="w-12 h-12 bg-secondary-light/10 dark:bg-secondary-dark/10 rounded-lg flex items-center justify-center mb-3">
                                <i class="fas fa-certificate text-secondary-light dark:text-secondary-dark text-xl"></i>
                            </div>
                            <h3 class="text-xl font-bold text-secondary-light dark:text-secondary-dark">PG Diploma in Computer Application</h3>
                            <p class="text-gray-500 dark:text-gray-400 text-sm mt-1">Government Polytechnic, Lucknow</p>
                        </div>
                        <span class="bg-secondary-light/20 dark:bg-secondary-dark/20 text-secondary-light dark:text-secondary-dark text-xs px-3 py-1 rounded-full h-fit whitespace-nowrap">
                            2019 - 2021
                        </span>
                    </div>
                    <ul class="text-sm text-gray-600 dark:text-gray-400 space-y-3 mt-4 flex-grow">
                ...
                <!-- BSc Card -->
                <div class="bg-white dark:bg-dark p-6 rounded-xl border border-gray-200 dark:border-gray-800 hover:border-accent-light dark:hover:border-accent-dark transition-all duration-300 hover:shadow-lg hover:-translate-y-1 flex flex-col h-full equal-height">
                    <div class="flex justify-between items-start mb-4">
                        <div>
                            <div class="w-12 h-12 bg-accent-light/10 dark:bg-accent-dark/10 rounded-lg flex items-center justify-center mb-3">
                        ...
                        <span class="bg-accent-light/20 dark:bg-accent-dark/20 text-accent-light dark:text-accent-dark text-xs px-3 py-1 rounded-full h-fit">2015 - 2018</span>
                    </div>
                    <ul class="text-sm text-gray-600 dark:text-gray-400 space-y-3 mt-4 flex-grow">
                        <li class="flex items-start">
                            <i class="fas fa-check-circle text-primary-light dark:text-primary-dark mr-3 mt-0.5"></i>
            ...
            <div class="max-w-4xl mx-auto mt-12">
                <div class="bg-white dark:bg-dark p-6 rounded-xl border border-gray-300 dark:border-gray-700 shadow-md">
                    <h3 class="text-xl font-semibold mb-4 text-center text-primary-light dark:text-primary-dark">Additional Certifications</h3>
            ...
            <div class="relative">
                ...
                <div class="flex flex-col md:flex-row items-stretch justify-between gap-6 md:gap-8">
                    ...
                    <div class="w-full md:w-1/2 relative group flex flex-col">
                        ...
                        <div
                            ...
                            <div class="flex items-center mb-5">
                                <div class="w-3 h-3 rounded-full bg-accent-light dark:bg-accent-dark mr-3 animate-pulse"></div>
                                <p class="text-sm font-semibold text-accent-light dark:text-accent-dark tracking-wider">CURRENT POSITION</p>
                            </div>
                            <h3 class="text-2xl font-bold text-gray-800 dark:text-white mb-2 text-left">Software Engineer Trainee</h3>
                            <h4 class="text-primary-light dark:text-primary-dark text-lg mb-4 text-left">IPH Technology Pvt. Ltd., Lucknow</h4>
                            <p class="text-gray-600 dark:text-gray-400 mb-6 text-left">Feb 2025 - Present</p>
                            <ul class="space-y-3 text-left">
                                <li class="flex items-start">
                                    <svg class="w-5 h-5 text-accent-light dark:text-accent-dark mt-0.5 mr-3 flex-shrink-0" fill="none"
                                        stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M5 13l4 4L19 7"></path>
                                    </svg>
                                    <span class="text-gray-700 dark:text-gray-300">Developing web applications using PHP, Laravel,
                                ...
                                <li class="flex items-start">
                                    ...
                                    <span class="text-gray-700 dark:text-gray-300">Designing responsive front-end interfaces using HTML,
                                ...
                                <li class="flex items-start">
                                    ...
                                    <span class="text-gray-700 dark:text-gray-300">Assisting in debugging, testing, and optimizing website
                                        performance</span>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="hidden md:flex flex-col items-center justify-center py-4 relative z-10 mx-2">
                        ...
                        <div class="w-1 h-16 bg-gradient-to-b from-primary-light dark:from-primary-dark to-accent-light dark:to-accent-dark"></div>
                        <div
                    ...
                    <div class="w-full md:w-1/2 relative group flex flex-col mt-8 md:mt-0">
                        ...
                        <div
                            class="relative h-full bg-white/90 dark:bg-gray-800/90 backdrop-blur-md p-8 rounded-3xl shadow-2xl border border-gray-300/60 dark:border-gray-700/60 hover:border-primary-light/40 dark:hover:border-primary-dark/40 transition-all duration-300 flex-grow">
                            <h3 class="text-2xl font-bold text-gray-800 dark:text-white mb-2 text-left">PHP Developer Intern</h3>
                            <h4 class="text-primary-light dark:text-primary-dark text-lg mb-4 text-left">LogZero Technology Pvt. Ltd., Noida</h4>
                            ...
                            <ul class="space-y-3 text-left">
                                <li class="flex items-start">
                                    ...
                                    <span class="text-gray-700 dark:text-gray-300">Gained hands-on experience in developing web
                                ...
                                <li class="flex items-start">
                                    ...
                                    <span class="text-gray-700 dark:text-gray-300">Collaborated on creating responsive, user-friendly
                                ...
                                <li class="flex items-start">
                                    ...
                                    <span class="text-gray-700 dark:text-gray-300">Played a role in API integrations and provided support
                    ...
                    <div class="md:hidden flex flex-row items-center justify-center py-4 w-full">
                        ...
                        <div class="w-16 h-1 bg-gradient-to-r from-primary-light dark:from-primary-dark to-accent-light dark:to-accent-dark"></div>
                        <div
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white dark:bg-darker rounded-xl overflow-hidden shadow-lg card-hover equal-height">
                    <div class="h-48 bg-gradient-to-r from-primary-light dark:from-primary-dark to-accent-light dark:to-accent-dark flex items-center justify-center">
                ...
                <!-- Project 2 -->
                <div class="bg-white dark:bg-darker rounded-xl overflow-hidden shadow-lg card-hover equal-height">
                    <div class="h-48 bg-gradient-to-r from-secondary-light dark:from-secondary-dark to-accent-light dark:to-accent-dark flex items-center justify-center">
                ...
                <!-- Project 3 -->
                <div class="bg-white dark:bg-darker rounded-xl overflow-hidden shadow-lg card-hover equal-height">
                    <div class="h-48 bg-gradient-to-r from-accent-light dark:from-accent-dark to-secondary-light dark:to-secondary-dark flex items-center justify-center">
                    ...
                    <div class="p-6 flex flex-col h-full">
                        <div>
                            ...
                            <div class="flex flex-wrap gap-2 mb-4">
                                ...
                                <span class="px-3 py-1 bg-primary-light/10 dark:bg-primary-dark/10 text-primary-light dark:text-primary-dark rounded-full text-xs">Divi
                                    Theme</span>
                                <span
